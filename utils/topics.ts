import { TopicKey } from '../contexts/SettingsContext';

export const TOPIC_SUBTOPICS: Record<TopicKey, string[]> = {
  'breaking': [
    'India', 'World', 'Politics', 'Economy', 'Conflict', 'Tech',
    'Environment', 'Health', 'Crime', 'Disaster', 'Sports', 'Entertainment',
  ],
  'technology': [
    'AI & ML', 'Mobile', 'Cybersecurity', 'Space', 'Tech Startups',
    'Science', 'Social Media', 'Crypto & Web3', 'EVs', 'Gaming',
    'Cloud & SaaS', 'Semiconductors', 'Robotics',
  ],
  'india-politics': [
    'BJP', 'Congress', 'AAP', 'Elections', 'Courts & Law',
    'Defence', 'India Economy', 'Agriculture', 'Education',
    'Society', 'State Politics', 'Foreign Policy', 'Sports', 'Entertainment',
  ],
  'geopolitics': [
    'Iran', 'Trump & USA', 'Ukraine', 'Russia', 'China',
    'Middle East', 'Israel & Gaza', 'Pakistan', 'NATO',
    'EU & Europe', 'Africa', 'Climate Diplomacy', 'Oil & Energy',
  ],
  'markets': [
    'Stocks', 'Crypto', 'Gold', 'Oil', 'Forex',
    'Fed', 'RBI', 'IPO', 'Bonds', 'Commodities',
    'Sensex & Nifty', 'Global Markets',
  ],
  'business': [
    'Startups', 'M&A', 'Earnings', 'Energy', 'Banking & Fintech',
    'Retail & E-commerce', 'Real Estate', 'Aviation', 'Manufacturing',
    'Pharma', 'Telecom', 'Auto',
  ],
};

export const SUBTOPIC_KEYWORDS: Record<string, string[]> = {
  // ── Breaking ──────────────────────────────────────────────────
...
// Compact keyword sets used to detect the real category of a "breaking" story
