    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: 14, paddingLeft: clusterCard ? 20 : 14 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.75)', fontSize: 7, fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', minWidth: 0 }}>{source.toUpperCase()}</span>
          ...
          <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: 7, flexShrink: 0 }}>·</span>
          <span style={{ color: 'rgba(255,255,255,0.75)', fontSize: 7, fontWeight: 600, whiteSpace: 'nowrap', flexShrink: 0 }}>{timeFormat === 'absolute' ? timeAbs(story.publishedAt) : timeAgo(story.publishedAt)}</span>
